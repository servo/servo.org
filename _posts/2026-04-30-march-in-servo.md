...
<figure>
    <a href="{{ '/img/blog/2026-04-debugger.png' | url }}"><img src="{{ '/img/blog/2026-04-debugger.png' | url }}" alt="screenshot of the DevTools debugger, showing live variable values"></a>
</figure>
