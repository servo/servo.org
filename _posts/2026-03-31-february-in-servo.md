...
We’ve fixed crashes in DevTools, in the Inspector tab (@eerii, @mrobinson, #42330), when exiting Servo while DevTools is connected (@simonwuelker, #42543), when setting breakpoints in some cases (@atbrakhi, #42810), and after clients disconnect in some cases (@simonwuelker, #42583).
