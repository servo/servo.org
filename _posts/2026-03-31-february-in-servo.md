...
We now have our first **truly incremental box tree layout** (@mrobinson, @Loirooriol, @lukewarlow, #42700), rather than our previous “dirty roots”-based approach.
Depending on how they were [damaged](https://en.wikipedia.org/wiki/Dirty_bit), some boxes for **floats** (as above, #42816), **independent formatting contexts** (as above, #42783), and their descendants (as above, #42582) can now be reused, and they avoid damaging their parents (as above, #42847).
We also destroy boxes with ‘display: none’ earlier in the layout process (as above, #42584).
