...
In addition, we’ve **reduced the size of the final Servo binary** by 2mb by stripping out DOM code that should never be used outside of automated tests ([@jdm](https://github.com/jdm), [#37034](https://github.com/servo/servo/pull/37034)).
